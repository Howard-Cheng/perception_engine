...
#ifdef _WIN32
#ifdef LLM_SUMMARY_EXPORTS
#define LLM_SUMMARY_API __declspec(dllexport)
#else
#define LLM_SUMMARY_API __declspec(dllimport)
#endif
#else
#define LLM_SUMMARY_API
#endif
...
namespace perception
{
     ...
     */
    struct LLM_SUMMARY_API LLMConfig
    {
     ...
     */
    struct LLM_SUMMARY_API ChatMessage
    {
     ...
     */
    struct LLM_SUMMARY_API DatabaseRecord
    {
        std::string id;
        std::string type;
        std::string title;
     ...
     */
    class LLM_SUMMARY_API LLMClient
    {
    public:
        /**
         * @brief Constructor
     ...
     */
    LLM_SUMMARY_API std::filesystem::path getDefaultModelPath();
